...
public class FMOD_Commands_PL_FIX : MonoBehaviour
{
    ...
    {
        // EVENT
        Music = FMODUnity.RuntimeManager.CreateInstance(musicEvent); // Tworzy nową instancję eventu Music.
